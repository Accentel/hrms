                    ...
                    <div class="page-content">	
                        ...
                        <div class="page-header">
                          ...
                          if(isset($_POST['submit'])){
                              $user=$_POST['uname'];
                              $amount=$_POST['amount'];
                              $u=mysqli_query($link,"insert into usersamount(uname,amount)values('$user','$amount')") or die(mysqli_error($link));
                                    ...
                                    <div class="col-xs-12">
                                            ...
                                            <tr> <td align="right">User Name</td><td><select  name="uname" id="uname" required class="form-control" >
                                                ...
                                                while($k1=mysqli_fetch_array($k)){
                                                    ?>
                                                    <option value="<?php echo $k1['user'] ?>"><?php echo $k1['user'] ?></option>
                                                <?php } ?>
                                            </select>    
                                            </td>
                                           </tr>
                                         ...
                                         <tr><td align="right">Amount</td><td align="left"><input type="text"  class="form-control" name="amount" id="amount"></td>
