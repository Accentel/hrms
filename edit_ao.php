                                    ...
                                    <div class="col-xs-12">
										...
										<input type="file" required name="file"class="form-control" accept=".pdf"value="<?php echo $rw['file'];?>"/></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left">
                                                        <input type="text" required name="cert1" id="cert1" value="<?php echo $rw['certi1'] ?>" class="form-control">
                                                    </td>
                                                    <td align="right">Certificate Name Submited</td>
                                                    <td>
                                                        <input type="text" required name="cert2" id="cert2" value="<?php echo $rw['certi2'] ?>" class="form-control">
                                                    </td>
                                                </tr>
