                                        ...
                                        <form name="frm" method="post" action="dep_suc.php?state=<?php echo $state; ?>" enctype="multipart/form-data">
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left"><input type="text" value="<?php echo $rw['designation'] ?>" class="form-control" name="address" id="address"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left">
                                                        <textarea  name="loc" id="loc" class="form-control"><?php echo $rw['address'] ?></textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><input type="date" name="join_date" id="join_date" value="<?php echo date('d-m-Y', strtotime($rw["DOJ"])) ?>" class="form-control"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text"  name="sub" id="sub" value="<?php echo $rw['sub'] ?>" class="form-control">
                                                    </td>
                                                   </tr>
                                                ...
                                                <tr>
                                                    <td align="right">Location</td>
                                                    <td align="left">
                                                        <input type="text" value="<?php echo $rw[''] ?>" class="form-control" name="location" id="location">
                                                    </td>
