...
if (isset($_POST['submit'])) {
 ...
 //if the form variables are not empty then update data into database
       ...
       rno='$rno',wname='$wname',nok='$nok',childname='$childname',pan='$pan',designation='$designation',ESI_NO='$ESI_NO',PFNO='$PFNO',sitename='$sitename',uniform='$uniform',uniformisdate='$uniformisdate',empsign='$empsign',permaddress='$permaddress',localaddress='$localaddress',refeaddress='$refeaddress',photo='$fileName15',emp_email='$emp_email',username='$username',password='$password',bname='$bname'
       ,branch='$branch',ifsc='$ifsc',accno='$accno',level1='$level1',level2='$level2',level3='$level3',level4='$level4',level5='$level5',level6='$level6',level7='$level7',tshirt='$tshirt',tshtdt='$tshtdt',tsize='$tsize',phant='$phant',phtdt='$phtdt',psize='$psize',bg='$bg',stat='BLOCKED',
       sshoes='$sshoes',shoesdt='$shoesdt',ssize='$ssize', idcard='$idcard',idcarddt='$idcarddt',licensestatus='$licensestatus'
       where empid='$id'";
