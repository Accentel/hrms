...
<tr>
                                                    ...
                                                    <td align="right"> Office Uniform</td>
                                                        <td><select name="uniform" id="uniform" required class="form-control">
																<option value="T-Shirt" <?php echo ($rw["uniform"] == "T-Shirt") ? 'selected' : ''; ?>>NA</option>
																<option value="Shirt" <?php echo ($rw["uniform"] == "Shirt") ? 'selected' : ''; ?>>Available</option>
...
<table class="table">
                                                    ...
                                                    <td align="right">Shirt</td>
                                                        ...
                                                        <option value="T-Shirt Block" <?php echo ($rw["ushirt"] == "block") ? 'selected' : ''; ?>>T-Shirt Block</option>
                                                                    <option value="T-Shirt Blue" <?php echo ($rw["ushirt"] == "blue") ? 'selected' : ''; ?>>T-Shirt Blue</option>
                                                                    <option value="White Shirt" <?php echo ($rw["ushirt"] == "shite") ? 'selected' : ''; ?>>White Shirt</option>
                                                                    <option value="Brown Shirt" <?php echo ($rw["ushirt"] == "brown") ? 'selected' : ''; ?>>Brown Shirt</option>
                                                                    <option value="Knight frank" <?php echo ($rw["ushirt"] == "knight") ? 'selected' : ''; ?>>Knight frank</option>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" name="shirtsize" id="shirtsize"  class="form-control" value="<?php echo $rw['shirtsize'] ?>">
                                                            </td>
                                                            </tr>
                <tr>
                <tr>
                                                    <td align="right">Pant</td>
                                                        <td><select name="upant" id="upant" required class="form-control">
                                                                    <option value="Jeans Pant" <?php echo ($rw["upant"] == "jeans") ? 'selected' : ''; ?>>Jeans Pant</option>
                                                                    <option value="Block Pant" <?php echo ($rw["upant"] == "lock") ? 'selected' : ''; ?>>Block Pant</option>
                                                                    <option value="Regular Pant" <?php echo ($rw["upant"] == "regular") ? 'selected' : ''; ?>>Regular Pant</option>
                ...
                <tr>
                                                            <td align="right">Pant Size</td>
                                                                <td align="left">
                                                                    <input type="text" class="form-control"  id="pantsize" name="pantsize" value="<?php echo $rw['pantsize'] ?>">
                                                                </td>
                                                        </tr>

                                                        <td align="right">Shoe</td>
                                                        <td><select name="ushoe" id="ushoe" required class="form-control">
                                                                    <option value="pant" <?php echo ($rw["ushoe"] == "jeans") ? 'selected' : ''; ?>>Fiber</option>
                                                                    <option value="pant" <?php echo ($rw["ushoe"] == "lock") ? 'selected' : ''; ?>>Metal</option>
                                                                    <option value="pant" <?php echo ($rw["ushoe"] == "regular") ? 'selected' : ''; ?>>Steel</option>
                ...
                <tr>
                                                            <td align="right">Shoe Size</td>
                                                                <td align="left">
                                                                    <input type="text" class="form-control"  id="shoesize" name="shoesize" value="<?php echo $rw['shoesize'] ?>">
                                                                </td>
                                                        </tr>
                ...
                <tr>
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" name="nname" id="nname"  class="form-control" value="<?php echo $rw['nname'] ?>" placeholder="Enter Name">
                                                            </td>
                                                            </tr>
                <tr>
                ...
                <tr>
                                                        ...
                                                        <<td align="right">Nominee DOB</td>
                                                                <td align="left">
                                                                    <input type="date" value="<?php echo date('Y-m-d', strtotime($rw["ndob"])) ?>" class="form-control"  id="ndob" name="ndob" value="<?php echo $rw['ifsc'] ?>">
                                                                </td>
                                                        </tr>
...
<tr>
                                                ...
                                                <td align="left">
                                                    <input type="text" class="form-control" value="<?php echo $rw['empsign'] ?>" name="empsign" id="empsign">
                                                </td>
                                            </tr>
