...
<div class="box-small" style="border: 2px solid black; padding: 10px; width:300px; margin-left: 200px; margin-top: 20px;">
    ...
    <td style="border:2px solid black; font-weight:bold;"><b>PARENT/SPOUSE NAME</b></td>
    <td style="border:2px solid black; text-align: center;">
        <?php
        ...
        if ($rw['relation'] == 'father' || ($rw['maritalstatus'] == 'unmarried' && empty($rw['relation']))) {
            // If unmarried, or if the relation is 'father', show the father name
            echo $rw['fname'];
        } elseif ($rw['relation'] == 'spouse' || ($rw['maritalstatus'] == 'married' && empty($rw['relation']))) {
...
<table style="border: 1px solid black; width: 70%; margin: auto; border-collapse: collapse;">
    ...
    <td style="border: 1px solid black; padding: 5px; width: 60%;">
        <label>
            <input type="radio" name="relation" value="father" <?php echo ($rw['relation'] == 'father' || ($rw['maritalstatus'] == 'unmarried' && empty($rw['relation']))) ? 'checked' : ''; ?>> Father Name
        </label>
        <label>
            <input type="radio" name="relation" value="spouse" <?php echo ($rw['relation'] == 'spouse' || ($rw['maritalstatus'] == 'married' && empty($rw['relation']))) ? 'checked' : ''; ?>> Spouse Name
        </label>
    ...
    <td style="border: 1px solid black; padding: 2px; width: 35%;">
        <?php 
            ...
            if ($rw['maritalstatus'] == 'unmarried') {
                echo $rw['fname']; // Display Father's name for unmarried
            } elseif ($rw['maritalstatus'] == 'married') {
                echo $rw['wname']; // Display Spouse's name for married
            } else {
                echo "No valid name available"; // Fallback message
            }
        ?>
    </td>
</tr>
...
<table style="width: 100%; border-collapse: collapse;">
    ...
    <tr>
        ...
        <td style=" padding: 5px;">
            <span style="font-size: 15px;"><?php echo ($rw['fname']); ?></span>
        </td>
    </tr>
    <tr>
        <td style=" padding: 5px;">
    ...
    <tr>
        ...
        <td style=" padding: 5px;">
            <span style="font-size: 15px;"><?php echo $rw['tempaddress']; ?></span>
        </td>
    </tr>
</table>
...
<p style="font-size: 15px;">Certified that above declaration and nomination has been signed/thumb impressed before me by shri/smt./kum <span style="text-decoration: underline; text-decoration-style: dotted; font-size: 15px;"><?php echo $rw['emp_name'] ?></span></p>
